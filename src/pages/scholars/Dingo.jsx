        ...
        <section className="max-w-5xl w-full mx-auto my-50 mt-14 flex flex-wrap">
          <ScholarArticleWrapper name="Dingo" chart={dingoChart}>
            ...
            <p>
              ...
              ethnicity. My family and I relocated to Mae La Camp, a refugee
              camp along the Thai-Burma border in 2008 as my family were living
              and financial issues then and we have been staying there for 10
              years ever since.
            </p>
            <br />
            <br />
            <p>
              ...
              and Computer Centre (ALCC) in the camp. I then obtained a Diploma
              in Liberal Studies in Australian Catholic University through a
              combination of online and face-to-face lessons and graduated in
              the year 2013. After graduation, I spent 4-5 years working in
              various INGOs, including Save the Children, Burma Link and Human
              Rights Watch conducting translation work and other administrative
              duties.
            </p>
            <br />
            <br />
            ...
            <p>
              ...
              social entrepreneurship in particular intrigues me much. In the
              year of 2018, I got an offer from the University of the Thai
              Chamber of Commerce (UTCC) to study Business Management. While I
              very much wish to take up the offer, I struggled to obtain
              financial support for my studies. And it was at that time that I
              turned to Connecting Myanmar for their support.
            </p>
            <br />
            <br />
            <p>
              My story with Connecting Myanmar traced back to the summer of 2011
              when volunteers from the University of Hong Kong came taught
              English at ALCC. There I met Patricia, who now is one of the
              co-founders of Connecting Myanmar and subsequently, got introduced
              to Edward, Rose and many others involved in the organization. It
              did not take long before we became friends and what Connecting
              Myanmar does right now continues to be a positive motivation to me
              to turn dreams of serving the underprivileged into practical
              reality.
            </p>
            <br />
            <br />
            <p>
              ...
              United States joining different student exchange programs, acting
              as ASEAN ambassador, taking part in business competitions and
              attending courses abroad together with students from Myanmar,
              India, South Africa, China and many more.
            </p>
            <br />
            <br />
            <p>My aspiration</p>
            ...
            <p>
              ...
              taught himself English by reading books borrowed from the library
              of a refugee camp in order to pass the entrance test of a school.
              With perseverance and courage, he always chooses to step out of
              his comfort zone and grow." - Patricia Chen, former teacher of
              Dingo from HKU​, coordinator of Connecting Myanmar"
            </p>
